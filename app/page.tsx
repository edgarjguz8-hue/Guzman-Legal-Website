  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] text-[#071226]">
      <section className="relative overflow-visible bg-[#082f63] px-7 pb-32 pt-6 text-white">
        ...
        <div className="pointer-events-none absolute right-6 top-14 hidden opacity-15 lg:block xl:right-12">
          <Image
            src="/logo-white.png"
            alt=""
            width={700}
        ...
        <div className="pointer-events-none absolute right-16 top-36 hidden grid-cols-8 gap-5 opacity-40 lg:grid">
